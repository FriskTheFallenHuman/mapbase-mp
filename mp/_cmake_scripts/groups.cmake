...
if (${BUILD_GROUP} STREQUAL "game")
	...
	elseif(${BUILD_GAME} STREQUAL "episodic")
		...
		include("${SRCDIR}/game/gamepadui/gamepadui_episodic.cmake")
	...
	include("${SRCDIR}/responserules/runtime/response_rules.cmake")
...
elseif (${BUILD_GROUP} STREQUAL "maptools")
