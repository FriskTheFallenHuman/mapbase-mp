...
int RunVBSP( int argc, char** argv )
{
	...
	// to get the "g_source" name, and append extensions as desired...
	char		mapFile[1024];
...
#ifdef MAPBASE
				"  -noleaktest    : Disables the creation of <vmf filename>.lin.\n"
#else
...
#ifdef MAPBASE
				"  -insert_search_path <directory> : Includes an extra base directory for mounting additional content.\n"
