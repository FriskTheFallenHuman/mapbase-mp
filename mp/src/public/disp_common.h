...
public:
	...
	{
		return m_Index;    // Get the vert index for the displacement in pUtils.
	}
	const CVertIndex&	GetNBVertIndex() const
	{
		return m_NBIndex;    // Get the neighbor's vert index.
	}
...
public:
	...
	const CVertIndex&	GetVertIndex() const
	{
		return m_It.GetVertIndex();    // Get the vert index for the displacement in pUtils.
	}
	const CVertIndex&	GetNBVertIndex() const
	{
		return m_It.GetNBVertIndex();    // Get the neighbor's vert index.
	}
