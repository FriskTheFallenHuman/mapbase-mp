...
struct AI_ResponseFollowup
{
	...
	{
		return ( followup_concept && followup_contexts );
	}
	inline void Invalidate()
	{
		followup_concept = NULL;
		followup_contexts = NULL;
	}
	inline void SetFired( bool fired )
	{
		bFired = fired;
	}
	inline bool HasBeenFired()
	{
		return bFired;
	}
...
public:
	...
	inline void	OverrideOnAppend( bool bOverride )
	{
		m_bOverrideOnAppend = bOverride;
	}
...
public:
	...
	const ResponseParams* GetParams() const
	{
		return &m_Params;
	}
	...
	inline float	GetMatchScore( void )
	{
		return m_fMatchScore;
	}
	inline void		SetMatchScore( float f )
	{
		m_fMatchScore = f;
	}
	...
	inline short*	GetInternalIndices()
	{
		return m_InternalIndices;
	}
	inline void		SetInternalIndices( short iGroup, short iWithinGroup )
	{
		m_InternalIndices[0] = iGroup;
		m_InternalIndices[1] = iWithinGroup;
	}
#else
	bool			IsApplyContextToWorld( void )
	{
