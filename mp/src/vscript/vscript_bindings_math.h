...
//-----------------------------------------------------------------------------
inline matrix3x4_t* ToMatrix3x4( HSCRIPT hMat )
{
	return HScriptToClass<matrix3x4_t>( hMat );
}
...
inline Quaternion* ToQuaternion( HSCRIPT hQuat )
{
	return HScriptToClass<Quaternion>( hQuat );
}
