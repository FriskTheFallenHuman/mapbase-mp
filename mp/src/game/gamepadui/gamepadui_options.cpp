...
#ifdef MAPBASE_STEAMDECK // Steam input and Steam Controller are not supported in SDK2013 (Madi)
...
int GetCurrentDisplayMode()
{
	...
	if ( config.Windowed() )
	{
#ifdef MAPBASE_STEAMDECK // SDK2013 does not natively support borderless windowed (Madi)
