...
public:
	...
	void SetAllowInterrupt( bool bAllowInterrupt )
	{
		m_bAllowInterruption = bAllowInterrupt;
	}
	void SetStopAllSounds( bool bStopAllSounds )
	{
		m_bStopAllSounds = bStopAllSounds;
	}
#ifdef MAPBASE
	...
	void SetFade( float flStartFade, float flEndFade )
	{
		m_flFadeIn = flStartFade;
		m_flFadeOut = flEndFade;
	}
#endif
