...
set(
	...
	"${CLIENT_HL2MP_DIR}/episodic/c_prop_scalable.cpp"
	...
	"${CLIENT_HL2MP_DIR}/episodic/c_vehicle_jeep_episodic.cpp"
	...
	"${CLIENT_HL2MP_DIR}/episodic/c_npc_advisor.cpp"
	"${CLIENT_HL2MP_DIR}/episodic/episodic_screenspaceeffects.cpp"
	"${CLIENT_HL2MP_DIR}/episodic/episodic_screenspaceeffects.h"
	"${CLIENT_HL2MP_DIR}/episodic/flesh_internal_material_proxy.cpp"
	...
	"${CLIENT_HL2MP_DIR}/hl2/hud_locator.cpp"
	"${CLIENT_HL2MP_DIR}/hl2/hud_health.cpp"
	"${CLIENT_HL2MP_DIR}/hl2/hud_poisondamageindicator.cpp"			
	"${CLIENT_HL2MP_DIR}/hud_posture.cpp"
	"${CLIENT_HL2MP_DIR}/hl2/hud_quickinfo.cpp"
	"${CLIENT_HL2MP_DIR}/hl2/hud_radar.cpp"
	"${CLIENT_HL2MP_DIR}/hl2/hud_radar.h"
	...
	"${CLIENT_HL2MP_DIR}/episodic/c_npc_puppet.cpp"
...
if (${MAPBASE_GIGALIB})
	TargetBuildAndAddProto(client_hl2mp "${SRCDIR}/thirdparty/gigalib/src/networking/messages.proto" "${SRCDIR}/thirdparty/gigalib/src/networking")
endif()

target_include_directories(
	client_hl2mp PRIVATE
	"${CLIENT_HL2MP_DIR}/hl2"
	"${CLIENT_HL2MP_DIR}/episodic"
