...
public:
	...
	{
		return GetRenderOrigin();    // Return the origin for player observers tracking this target
	}
...
public:
	...
	{
		return ( ( GetFlags() & FL_FAKECLIENT ) == FL_FAKECLIENT ) ? true : false;
	}
	...
	virtual void			GetEyePosition( Vector& vecOrigin, QAngle& angAngles )
	{
