...
void CHalfLife2Proxy::InputEpisodicOn( inputdata_t& inputdata )
{
	KeyValue( "SetEpisodic", "1" );
}
void CHalfLife2Proxy::InputEpisodicOff( inputdata_t& inputdata )
{
	KeyValue( "SetEpisodic", "0" );
}
void CHalfLife2Proxy::InputSetFriendlyFire( inputdata_t& inputdata )
{
	KeyValue( "GlobalFriendlyFire", inputdata.value.String() );
}
void CHalfLife2Proxy::InputSetDefaultCitizenType( inputdata_t& inputdata )
{
	KeyValue( "DefaultCitizenType", inputdata.value.String() );
}
void CHalfLife2Proxy::InputSetLegacyFlashlight( inputdata_t& inputdata )
{
	KeyValue( "SetLegacyFlashlight", inputdata.value.String() );
}
void CHalfLife2Proxy::InputSetPlayerSquadAutosummon( inputdata_t& inputdata )
{
	KeyValue( "SetPlayerSquadAutosummon", inputdata.value.String() );
}
void CHalfLife2Proxy::InputSetStunstickPickupBehavior( inputdata_t& inputdata )
{
	KeyValue( "SetStunstickPickupBehavior", inputdata.value.String() );
}
#ifdef MAPBASE_MP
void CHalfLife2Proxy::InputSetAllowRespawning( inputdata_t& inputdata )
{
	KeyValue( "SetAllowRespawning", inputdata.value.String() );
}
#else
void CHalfLife2Proxy::InputSetAllowSPRespawn( inputdata_t& inputdata )
{
	KeyValue( "SetAllowSPRespawn", inputdata.value.String() );
}
#endif
...
ConVar	sk_max_sniper_round( "sk_max_sniper_round", "0", FCVAR_REPLICATED );
	...
	ConVar	sk_max_cguard_ammo( "sk_max_cguard_ammo", "0", FCVAR_REPLICATED );
...
#endif
#ifdef MAPBASE_MP
		def.AddAmmoType( "CombineCannonPl",	DMG_BULLET,				TRACER_LINE,			"sk_npc_dmg_gunship_to_plr",		"sk_npc_dmg_gunship",			"sk_max_cguard_ammo",		1.5 * 750 * 12, 0 ); // hit like a 1.5kg weight at 750 ft/s
		def.AddAmmoType( "Tripwire",			DMG_BLAST,					TRACER_NONE,			"sk_plr_dmg_grenade",			"sk_npc_dmg_grenade",			"sk_max_tripwire",			0, 0 );
		def.AddAmmoType( "FlareRounds",		DMG_BURN,					TRACER_NONE,			"sk_plr_dmg_flare_round",		"sk_npc_dmg_flare_round",		"sk_max_flare_round",		0, 0 );
