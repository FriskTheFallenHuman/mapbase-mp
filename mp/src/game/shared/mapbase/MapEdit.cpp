				...
				while( pName )
				{
					...
					while( inputparams )
					{
						switch( iter )
						{
							// Input name
							case 0:
								pInputName = AllocPooledString( inputparams );
								break;
							// Input parameter
							case 1:
								varInputParam.SetString( AllocPooledString( inputparams ) );
								break;
							// Input delay
							case 2:
								flInputDelay = atof( inputparams );
								break;
							// Activator
							case 3:
								pActivator = gEntList.FindEntityByName( NULL, inputparams );
								break;
							// Caller
							case 4:
								pCaller = gEntList.FindEntityByName( NULL, inputparams );
								break;
							// Output ID
							case 5:
								iOutputID = atoi( inputparams );
								break;
						}
						iter++;
