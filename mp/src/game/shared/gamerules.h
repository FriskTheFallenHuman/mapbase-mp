...
// Functions to verify the single/multiplayer status of a game
	...
	{
		return "Half-Life 2";    // this is the game name that gets seen in the server browser
	}
...
// Healthcharger respawn control
	...
	{
		return 0;    // how long until a depleted HealthCharger recharges itself?
	}
