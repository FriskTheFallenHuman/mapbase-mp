...
// Purpose:
//-----------------------------------------------------------------------------
bool CSDKGameRules::AllowThirdPersonCamera( void )
{
#ifdef CLIENT_DLL
...
// Purpose:
//-----------------------------------------------------------------------------
bool CSDKGameRules::HaveSavedConvar( ConVarRef const& cvar )
{
	Assert( cvar.IsValid() );
...
void __MsgFunc_SavedConvar( bf_read& msg )
{
	...
	if( bReadKey && bReadValue )
	{
		...
		{
			SDKGameRules()->m_SavedConvars[ szKey ] = AllocPooledString( szValue );
		}
	}
}
...
// Purpose:
//-----------------------------------------------------------------------------
void CSDKGameRules::SaveConvar( ConVarRef const& cvar )
{
	Assert( cvar.IsValid() );
...
// Purpose:
//-----------------------------------------------------------------------------
void CSDKGameRules::RevertSingleConvar( ConVarRef& cvar )
{
	Assert( cvar.IsValid() );
...
// Purpose:
//-----------------------------------------------------------------------------
void CSDKGameRules::RevertSavedConvars()
{
...
// Purpose:
//-----------------------------------------------------------------------------
void CSDKGameRules::RegisterScriptFunctions( void )
{
