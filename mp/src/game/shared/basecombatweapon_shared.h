...
public:
	...
	{
		return true;    // return true if the weapon's allowed to deploy
	}
	...
	{
		return false;    // Is this weapon in its 'zoomed in' mode?
	}
	...
	{
		return 1.0f;    // allows a weapon to influence the perceived size of the target's autoaim radius.
	}
...
public:
...
#ifdef MAPBASE_VSCRIPT
	void				ScriptSetClip1( int ammo )
	{
		m_iClip1 = ammo;
	}
	void				ScriptSetClip2( int ammo )
	{
		m_iClip2 = ammo;
	}
	...
	int					ScriptWeaponClassify()
	{
		return WeaponClassify();
	}
	void				ScriptWeaponSound( int sound_type, float soundtime = 0.0f )
	{
		WeaponSound( ( WeaponSound_t )sound_type, soundtime );
	}

	const Vector&		ScriptGetBulletSpread( void )
	{
		return GetBulletSpread();
	}
	Vector				ScriptGetBulletSpreadForProficiency( int proficiency )
	{
		return GetBulletSpread( ( WeaponProficiency_t )proficiency );
	}

	int					ScriptGetPrimaryAttackActivity( void )
	{
		return GetPrimaryAttackActivity();
	}
	int					ScriptGetSecondaryAttackActivity( void )
	{
		return GetSecondaryAttackActivity();
	}
	int					ScriptGetDrawActivity( void )
	{
		return GetDrawActivity();
	}

	bool				FiresUnderwater()
	{
		return m_bFiresUnderwater;
	}
	void				SetFiresUnderwater( bool bVal )
	{
		m_bFiresUnderwater = bVal;
	}
	bool				AltFiresUnderwater()
	{
		return m_bAltFiresUnderwater;
	}
	void				SetAltFiresUnderwater( bool bVal )
	{
		m_bAltFiresUnderwater = bVal;
	}
	float				MinRange1()
	{
		return m_fMinRange1;
	}
	void				SetMinRange1( float flVal )
	{
		m_fMinRange1 = flVal;
	}
	float				MinRange2()
	...
	void				SetMaxRange2( float flVal )
	{
		m_fMaxRange2 = flVal;
	}
	//bool				ReloadsSingly() { return m_bReloadsSingly; }
	void				SetReloadsSingly( bool bVal )
	{
		m_bReloadsSingly = bVal;
	}
	float				FireDuration()
	{
		return m_fFireDuration;
	}
	void				SetFireDuration( float flVal )
	{
		m_fFireDuration = flVal;
	}
	...
	void				SetNextPrimaryAttack( float flVal )
	{
		m_flNextPrimaryAttack = flVal;
	}
	float				NextSecondaryAttack()
	{
		return m_flNextSecondaryAttack;
	}
	void				SetNextSecondaryAttack( float flVal )
	{
		m_flNextSecondaryAttack = flVal;
	}
#endif
...
public:
	...
	inline bool		HasSpawnFlags( int flags )
	{
		return ( m_spawnflags & flags ) != 0;
	}
	inline void		RemoveSpawnFlags( int flags )
	{
		m_spawnflags &= ~flags;
	}
	inline void		AddSpawnFlags( int flags )
	{
		m_spawnflags |= flags;
	}
#else
