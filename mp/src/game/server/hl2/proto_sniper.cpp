...
#ifdef MAPBASE
	const Vector& GetPaintCursor()
	{
		return m_vecPaintCursor;
	}
#endif
...
#ifdef MAPBASE
			flShotDist = ( GetAbsOrigin() - GetEnemy()->GetAbsOrigin() ).Length2D();
#else
			flShotDist = ( GetLocalOrigin() - GetEnemy()->GetLocalOrigin() ).Length2D();
#endif
