...
public:
	...
	float GetItemAmount()
	{
		return sk_healthkit.GetFloat() * m_flHealthMultiplier;
	}

	void	InputSetHealthMultiplier( inputdata_t& inputdata )
	{
		m_flHealthMultiplier = inputdata.value.Float();
	}
...
public:
	...
	float GetItemAmount()
	{
		return sk_healthvial.GetFloat() * m_flHealthMultiplier;
	}
...
public:
	...
	float GetItemAmount()
	{
		return m_flHealthAmount;
	}

	void	InputSetHealthAmount( inputdata_t& inputdata )
	{
		m_flHealthAmount = inputdata.value.Float();
	}
