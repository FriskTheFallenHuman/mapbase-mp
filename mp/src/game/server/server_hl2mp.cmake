...
set(
	...
	"${SERVER_HL2MP_DIR}/ai_eventresponse.cpp"
	"${SERVER_HL2MP_DIR}/ai_eventresponse.h"
	...
	"${SERVER_HL2MP_DIR}/logic_achievement.cpp"
	...
	"${SERVER_HL2MP_DIR}/vehicle_choreo_generic.cpp"
	...
	"${SERVER_HL2MP_DIR}/episodic/ai_behavior_alyx_injured.cpp"
	"${SERVER_HL2MP_DIR}/episodic/ai_behavior_alyx_injured.h"
	...
	"${SERVER_HL2MP_DIR}/hl2/ai_behavior_operator.cpp"
	"${SERVER_HL2MP_DIR}/hl2/ai_behavior_operator.h"
	"${SERVER_HL2MP_DIR}/ai_behavior_passenger.cpp"
	"${SERVER_HL2MP_DIR}/ai_behavior_passenger.h"
	"${SERVER_HL2MP_DIR}/episodic/ai_behavior_passenger_companion.cpp"
	"${SERVER_HL2MP_DIR}/episodic/ai_behavior_passenger_companion.h"
	"${SERVER_HL2MP_DIR}/episodic/ai_behavior_passenger_zombie.cpp"
	"${SERVER_HL2MP_DIR}/episodic/ai_behavior_passenger_zombie.h"
	...
	"${SERVER_HL2MP_DIR}/hl2/grenade_spit.cpp"
	"${SERVER_HL2MP_DIR}/hl2/grenade_spit.h"
	...
	"${SERVER_HL2MP_DIR}/hl2/info_darknessmode_lightsource.cpp"
	"${SERVER_HL2MP_DIR}/hl2/info_darknessmode_lightsource.h"
	...
	"${SERVER_HL2MP_DIR}/episodic/npc_advisor.cpp"
	"${SERVER_HL2MP_DIR}/hl2/npc_alyx_episodic.cpp"
	"${SERVER_HL2MP_DIR}/hl2/npc_alyx_episodic.h"
	"${SERVER_HL2MP_DIR}/hl2/npc_antlion.cpp"
	"${SERVER_HL2MP_DIR}/hl2/npc_antlion.h"
	"${SERVER_HL2MP_DIR}/hl2/npc_antlionguard.cpp"
	"${SERVER_HL2MP_DIR}/hl2/npc_antliongrub.cpp"
	...
	"${SERVER_HL2MP_DIR}/episodic/npc_combine_cannon.cpp"
	...
	"${SERVER_HL2MP_DIR}/hl2/npc_fastzombie.cpp"
	...
	"${SERVER_HL2MP_DIR}/episodic/npc_hunter.cpp"
	"${SERVER_HL2MP_DIR}/episodic/npc_hunter.h"
	"${SERVER_HL2MP_DIR}/hl2/npc_ichthyosaur.cpp"
	"${SERVER_HL2MP_DIR}/hl2/npc_kleiner.cpp"
	"${SERVER_HL2MP_DIR}/hl2/npc_launcher.cpp"
	"${SERVER_HL2MP_DIR}/episodic/npc_magnusson.cpp"
	...
	"${SERVER_HL2MP_DIR}/hl2/npc_scanner.h"
	...
	"${SERVER_HL2MP_DIR}/hl2/npc_zombine.cpp"
	...
	"${SERVER_HL2MP_DIR}/episodic/prop_scalable.cpp"
	...
	"${SERVER_HL2MP_DIR}/hl2/vehicle_cannon.cpp"
	"${SERVER_HL2MP_DIR}/hl2/vehicle_crane.cpp"
	"${SERVER_HL2MP_DIR}/hl2/vehicle_crane.h"
	"${SERVER_HL2MP_DIR}/hl2/vehicle_jeep.cpp"
	"${SERVER_HL2MP_DIR}/episodic/vehicle_jeep_episodic.cpp"
	"${SERVER_HL2MP_DIR}/episodic/vehicle_jeep_episodic.h"
	"${SERVER_HL2MP_DIR}/episodic/vehicle_hl2buggy.cpp"
	"${SERVER_HL2MP_DIR}/episodic/vehicle_hl2buggy.h"
	...
	"${SERVER_HL2MP_DIR}/episodic/weapon_striderbuster.cpp"
	"${SERVER_HL2MP_DIR}/episodic/weapon_striderbuster.h"
	"${SERVER_HL2MP_DIR}/episodic/ep1_gamestats.h"
	"${SERVER_HL2MP_DIR}/episodic/ep2_gamestats.h"
	"${SERVER_HL2MP_DIR}/episodic/ep1_gamestats.cpp"
	"${SERVER_HL2MP_DIR}/episodic/ep2_gamestats.cpp"
	"${SERVER_HL2MP_DIR}/hl2/func_bulletshield.cpp"
	"${SERVER_HL2MP_DIR}/hl2/func_bulletshield.h"
	"${SERVER_HL2MP_DIR}/episodic/npc_puppet.cpp"
