...
public:
	...
	{
		return m_isLoaded;    // return true if a Navigation Mesh has been loaded
	}
	bool IsAnalyzed( void ) const
	{
		return m_isAnalyzed;    // return true if a Navigation Mesh has been analyzed
	}
	...
	{
		return m_isOutOfDate;    // return true if the Navigation Mesh is older than the current map version
	}
	...
	{
		return m_areaCount;    // return total number of nav areas
	}
...
#define INCREMENTAL_GENERATION true
	...
	{
		return m_generationMode != GENERATE_NONE;    // return true while a Navigation Mesh is being generated
	}
	...
	{
		m_walkableSeeds.RemoveAll();    // erase all walkable seed positions
	}
	...
	{
		return m_markedLadder;    // return ladder marked by user in edit mode
	}

	CNavArea* GetSelectedArea( void ) const
	{
		return m_selectedArea;    // return area user is pointing at in edit mode
	}
	CNavLadder* GetSelectedLadder( void ) const
	{
		return m_selectedLadder;    // return ladder user is pointing at in edit mode
	}
	...
	{
		return m_editCursorPos;    // return position of edit cursor
	}
	...
	{
		return m_ladders;    // Returns the list of ladders
	}
