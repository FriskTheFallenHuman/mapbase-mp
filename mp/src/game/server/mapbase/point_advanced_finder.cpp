...
private:
	...
	void InputSetMaxResults( inputdata_t& inputdata )
	{
		m_iNumSearches = inputdata.value.Int();
	}
	void InputSetOutputDelay( inputdata_t& inputdata )
	{
		m_flOutputDelay = inputdata.value.Float();
	}
	void InputSetFiringMethod( inputdata_t& inputdata )
	{
		m_iFiringMethod = inputdata.value.Int();
	}
