...
public:
	...
	void SetGlowTarget( CBaseEntity* pActivator, CBaseEntity* pCaller )
	{
		m_hGlowTarget = gEntList.FindEntityByName( NULL, m_target, this, pActivator, pCaller );
	}
	...
	void InputSetTarget( inputdata_t& inputdata )
	{
		...
		SetGlowTarget( inputdata.pActivator, inputdata.pCaller );
	}

	void InputEnable( inputdata_t& inputdata )
	{
		m_bGlowDisabled = false;
		SetGlowTarget( inputdata.pActivator, inputdata.pCaller );
	}
	void InputDisable( inputdata_t& inputdata )
	{
		m_bGlowDisabled = true;
	}
	void InputToggle( inputdata_t& inputdata )
	{
		m_bGlowDisabled ? InputEnable( inputdata ) : InputDisable( inputdata );
	}
