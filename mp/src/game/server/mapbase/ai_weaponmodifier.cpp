...
public:
	...
	void InputSetBurstInterval( inputdata_t& inputdata )
	{
		WeaponModifierSetRange( inputdata.value.String(), m_ModdedRegulator.SetBurstInterval );
	}
	void InputSetRestInterval( inputdata_t& inputdata )
	{
		WeaponModifierSetRange( inputdata.value.String(), m_ModdedRegulator.SetRestInterval );
	}
	void InputSetBurstShotCountRange( inputdata_t& inputdata )
	{
		WeaponModifierSetRange( inputdata.value.String(), m_ModdedRegulator.SetBurstShotCountRange );
	}
	void InputSetBurstShotsRemaining( inputdata_t& inputdata )
	{
		m_ModdedRegulator.SetBurstShotsRemaining( inputdata.value.Int() );
	}

	void InputEnableShooting( inputdata_t& inputdata )
	{
		m_ModdedRegulator.EnableShooting();
	}
	void InputDisableShooting( inputdata_t& inputdata )
	{
		m_ModdedRegulator.DisableShooting();
	}
	void InputFireNoEarlierThan( inputdata_t& inputdata )
	{
		m_ModdedRegulator.FireNoEarlierThan( gpGlobals->curtime + inputdata.value.Float() );
	}
	void InputReset( inputdata_t& inputdata )
	{
		m_ModdedRegulator.Reset( inputdata.value.Bool() );
	}
