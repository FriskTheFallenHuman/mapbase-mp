...
public:
	...
	void SetFollowPathExactly( bool value )
	{
		m_bShouldFollowPathExactly = value;
	}
...
#define DONT_AVOID_OBSTACLES false
	...
	{
		m_isDebug = status;    ///< turn debugging on/off
	}

	bool IsStuck( void ) const
	{
		return m_stuckMonitor.IsStuck();    ///< return true if improv is stuck
	}
	...
	{
		return m_stuckMonitor.GetDuration();    ///< return how long we've been stuck
	}
