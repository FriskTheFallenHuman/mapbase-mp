...
//-----------------------------------------------------------------------------
// Purpose: Baseclass for any Advanced Non-Player Controller Bot
//-----------------------------------------------------------------------------
...
public:
	...
	virtual bool TaskStart( BotTaskInfo_t* info )
	{
		return false;
	}
	virtual bool TaskRun( BotTaskInfo_t* info )
	{
		return false;
	}
