...
ConVar bot_locomotion_allow_teleport( "bot_locomotion_allow_teleport", "1", FCVAR_SERVER, "Indica si los Bots pueden teletransportarse al quedar atascados." );
ConVar bot_locomotion_hiddden_teleport( "bot_locomotion_hiddden_teleport", "1", FCVAR_SERVER, "Indica si los Bots pueden teletransportarse solo si ningun Jugador los esta mirando" );
ConVar bot_locomotion_tolerance( "bot_locomotion_tolerance", "60", FCVAR_SERVER, "" );
ConVar bot_locomotion_allow_wiggle( "bot_locomotion_allow_wiggle", "1", FCVAR_SERVER, "" );
...
float CBotLocomotion::GetRunSpeed() const
{
	...
	float fRet = hl2_sprintspeed.GetFloat();
	return fRet;
#else
...
float CBotLocomotion::GetWalkSpeed() const
{
	...
	float fRet = hl2_normspeed.GetFloat();
	return fRet;
#else
	// This goes according to your mod
	return 80.0f;
