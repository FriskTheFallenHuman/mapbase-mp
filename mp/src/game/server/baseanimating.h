...
public:
	...
	inline float ScriptSequenceDuration( int iSequence )
	{
		return SequenceDuration( GetModelPtr(), iSequence );
	}
#endif
	...
	{
		*vecForceOut = vecForceIn;    // Base class does nothing.
	}
...
public:
	...
	int		ScriptSelectHeaviestSequence( int activity )
	{
		return SelectHeaviestSequence( ( Activity )activity );
	}
	int		ScriptSelectWeightedSequence( int activity, int curSequence )
	{
		return SelectWeightedSequence( ( Activity )activity, curSequence );
	}
