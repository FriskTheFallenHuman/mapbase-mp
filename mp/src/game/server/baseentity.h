...
public:
	...
	bool					IsWorld() const
	{
		extern CWorld* g_WorldEntity;    // Ported from the Alien Swarm SDK to fix false IsWorld() positives on server-only entities
		return ( void* )this == ( void* )g_WorldEntity;
	}
...
//	const QAngle&	GetAbsAngularVelocity( ) const;
	...
	{
		return true;    // allows entities to be 'invisible' to NPC senses.
	}
...
public:
	...
	void ScriptSetSolid( int i )
	{
		SetSolid( ( SolidType_t )i );
	}
