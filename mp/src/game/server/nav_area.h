...
public:
	...
	{
		return ( m_flags & IN_COVER ) ? true : false;    // return true if hiding spot in in cover
	}
	...
	{
		return m_pos;    // get the position of the hiding spot
	}
	...
	{
		return m_area;    // return nav area this hiding spot is within
	}
...
public:
	...
	{
		m_flags |= flags;    // FOR INTERNAL USE ONLY
	}
	void SetPosition( const Vector& pos )
	{
		m_pos = pos;    // FOR INTERNAL USE ONLY
	}
...
public:
	...
	unsigned int GetID( void ) const
	{
		return m_id;    // return this area's unique ID
	}
	...
	{
		m_place = place;    // set place descriptor
	}
	Place GetPlace( void ) const
	{
		return m_place;    // get place descriptor
	}
	...
	{
		return m_connect[ dir ].Count();    // return number of connected areas in given direction
	}
	...
	{
		return &m_incomingConnect[dir];    // get areas connected TO this area by a ONE-WAY link (ie: we have no connection back to them)
	}
	...
	{
		return m_elevatorAreas;    // return collection of areas reachable via elevator from this area
	}
	...
	{
		return m_isBattlefront;    // true if this area is a "battlefront" - where rushing teams initially meet
	}
