...
public:
	...
	void InputEnableUseInteraction( inputdata_t& inputdata )
	{
		AddSpawnFlags( SF_INTERACTABLE_USE_INTERACTS );
	}
	void InputDisableUseInteraction( inputdata_t& inputdata )
	{
		RemoveSpawnFlags( SF_INTERACTABLE_USE_INTERACTS );
	}
	void InputEnableTouchInteraction( inputdata_t& inputdata )
	{
		AddSpawnFlags( SF_INTERACTABLE_TOUCH_INTERACTS );
	}
	void InputDisableTouchInteraction( inputdata_t& inputdata )
	{
		RemoveSpawnFlags( SF_INTERACTABLE_TOUCH_INTERACTS );
	}
	void InputStartIgnoringCommandsWhenLocked( inputdata_t& inputdata )
	{
		AddSpawnFlags( SF_INTERACTABLE_IGNORE_COMMANDS_WHEN_LOCKED );
	}
	void InputStopIgnoringCommandsWhenLocked( inputdata_t& inputdata )
	{
		RemoveSpawnFlags( SF_INTERACTABLE_IGNORE_COMMANDS_WHEN_LOCKED );
	}
	void InputEnableRadiusInteract( inputdata_t& inputdata )
	{
		AddSpawnFlags( SF_INTERACTABLE_RADIUS_USE );
	}
	void InputDisableRadiusInteract( inputdata_t& inputdata )
	{
		RemoveSpawnFlags( SF_INTERACTABLE_RADIUS_USE );
	}
...
public:
	...
	virtual bool PassesDoorFilter( CBaseEntity* pEntity )
	{
		return !HasSpawnFlags( SF_DOOR_NONPCS );
	}
#endif
...
public:
	...
	virtual float GetFlareLifetime()
	{
		return m_flFlareLifetime;
	}
